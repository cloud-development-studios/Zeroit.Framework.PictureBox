...
namespace Zeroit.Framework.PictureBox.Helpers.Animations
{
    ...
    public class ControlBoundsAnimator : AnimatorBase
  {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ControlBoundsAnimator"/> class.
        /// </summary>
        /// <param name="container">The container.</param>
        public ControlBoundsAnimator(IContainer container)
      : base(container)
    {
      this.Initialize();
    }
    ...
    public Control Control
    {
      ...
      set
      {
        ...
        {
          this._control.LocationChanged -= OnCurrentValueChanged/*new EventHandler(((AnimatorBase) this).OnCurrentValueChanged)*/;
          this._control.SizeChanged -= OnCurrentValueChanged/*new EventHandler(((AnimatorBase) this).OnCurrentValueChanged)*/;
        }
        this._control = value;
        if (this._control != null)
        {
