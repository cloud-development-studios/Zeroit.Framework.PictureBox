...
{
    /// <summary>
    /// Class ControlBackColorAnimator.
    /// </summary>
    ...
    public class ControlBackColorAnimator : AnimatorBase
  {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ControlBackColorAnimator"/> class.
        /// </summary>
    ...
    public virtual Control Control
    {
      ...
      set
      {
        ...
        if (this._control != null)
          this._control.BackColorChanged -= OnCurrentValueChanged/*new EventHandler(((AnimatorBase) this).OnCurrentValueChanged)*/;
        this._control = value;
        if (this._control != null)
          this._control.BackColorChanged += OnCurrentValueChanged/*new EventHandler(((AnimatorBase) this).OnCurrentValueChanged)*/;
        this.ResetValues();
