...
namespace Zeroit.Framework.PictureBox.Helpers.Animations
{
    ...
    public class TrackBarValueAnimator : AnimatorBase
  {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackBarValueAnimator"/> class.
        /// </summary>
        /// <param name="container">The container.</param>
        public TrackBarValueAnimator(IContainer container)
      : base(container)
    {
    }
    ...
    public TrackBar TrackBar
    {
      ...
      set
      {
        ...
        if (this._trackBar != null)
          this._trackBar.ValueChanged -= /*new EventHandler(((AnimatorBase) this).OnCurrentValueChanged)*/OnCurrentValueChanged;
        this._trackBar = value;
        if (this._trackBar != null)
          this._trackBar.ValueChanged += OnCurrentValueChanged/*new EventHandler(((AnimatorBase) this).OnCurrentValueChanged)*/;
        this.ResetValues();
      }
    }
