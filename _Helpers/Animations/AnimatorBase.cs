...
namespace Zeroit.Framework.PictureBox.Helpers.Animations
{
    ...
    public abstract class AnimatorBase : Component, ISupportInitialize
  {
        /// <summary>
        /// The components
        /// </summary>
        ...
        /// </summary>
        private SynchronizationMode _syncMode = SynchronizationMode.None;
        /// <summary>
        /// The is initializing
        /// </summary>
    ...
    public AnimatorBase ParentAnimator
    {
      ...
      set
      {
        ...
        /// </summary>
        /// <value>The synchronization mode.</value>
        ...
        private void OnTimerElapsed(object sender, EventArgs e)
    {
      ...
      if (this._timer.Enabled && !this._neverEndingTimer && this._loopMode == LoopMode.None)
        this._timer.Stop();
      this.OnAnimationFinished(EventArgs.Empty);
      if (!enabled)
        return;
      if (this._loopMode == LoopMode.Repeat)
      {
        this.CurrentStep -= 100.0;
      }
      else
      {
        if (this._loopMode != LoopMode.Bidirectional)
          return;
