...
{
    /// <summary>
    /// Class ControlForeColorAnimator.
    /// </summary>
    ...
    public class ControlForeColorAnimator : AnimatorBase
  {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ControlForeColorAnimator"/> class.
        /// </summary>
    ...
    public Control Control
    {
      ...
      set
      {
        ...
        if (this._control != null)
          this._control.ForeColorChanged -= OnCurrentValueChanged/*new EventHandler(((AnimatorBase) this).OnCurrentValueChanged)*/;
        this._control = value;
        if (this._control != null)
          this._control.ForeColorChanged += OnCurrentValueChanged /*new EventHandler(((AnimatorBase) this).OnCurrentValueChanged)*/;
        this.ResetValues();
